...
public class EntradaDto {
	...
	public Integer getDepartamentoDto() {
		return departamentoDto;
	}

	public void setDepartamentoDto(Integer departamentoDto) {
		this.departamentoDto = departamentoDto;
	}

	public Integer getMunicipioDto() {
		return municipioDto;
	}

	public void setMunicipioDto(Integer municipioDto) {
